...
name: snap-forge
description: >
  Implement ready tasks with strict test-driven development. Use when the user
  wants to build features or fix bugs using TDD cycles, mentions
  "red-green-refactor", wants integration tests, or asks for test-first
  development with committed TDD progress.
---
